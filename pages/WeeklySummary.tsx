      ...
      <section className="bg-gray-50 p-6 rounded-3xl">
        ...
        <ul className="space-y-4">
          <li className="flex gap-3">
            ...
            <p className="text-xs text-gray-600 leading-relaxed font-medium">You completed <span className="font-bold text-gray-800">Quiz 2 for CSC584</span> on time. Great job!</p>
          </li>
          <li className="flex gap-3">
            <div className="text-yellow-500 pt-1"><Icons.Sparkles /></div>
            <p className="text-xs text-gray-600 leading-relaxed font-medium">Week 12 (Dec 30 - Jan 3) shows a <span className="font-bold text-gray-800">25% workload increase</span>. Week 13 is your critical window.</p>
          </li>
        </ul>
      </section>
