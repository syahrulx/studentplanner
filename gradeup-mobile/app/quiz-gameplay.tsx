...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: COLORS.white, paddingHorizontal: 24, paddingTop: 56, paddingBottom: 40 },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
  badge: { backgroundColor: 'rgba(0,45,90,0.08)', paddingHorizontal: 18, paddingVertical: 9, borderRadius: 14 },
  badgeText: { fontSize: 10, fontWeight: '800', color: COLORS.navy, letterSpacing: 0.5 },
  scoreRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  scoreText: { fontSize: 15, fontWeight: '800', color: COLORS.navy },
  ...
  optText: { fontSize: 16, fontWeight: '700', color: COLORS.navy, lineHeight: 22 },
