...
const styles = StyleSheet.create({
  ...
  inputTitle: { backgroundColor: COLORS.white, borderWidth: 1, borderColor: COLORS.border, borderRadius: 12, padding: 14, fontSize: 18, fontWeight: '700', marginBottom: 16 },
  inputContent: { backgroundColor: COLORS.white, borderWidth: 1, borderColor: COLORS.border, borderRadius: 12, padding: 14, fontSize: 16, minHeight: 200, marginBottom: 24 },
  saveBtn: { backgroundColor: COLORS.navy, paddingVertical: 16, borderRadius: 16, alignItems: 'center', marginBottom: 12 },
  pressed: { opacity: 0.95 },
  saveBtnText: { color: COLORS.white, fontSize: 16, fontWeight: '800' },
  cardsBtn: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 16, backgroundColor: COLORS.white, borderRadius: 16, borderWidth: 1, borderColor: COLORS.border },
  cardsBtnText: { fontSize: 16, fontWeight: '700', color: COLORS.navy },
});
