        ...
        <GestureDetector gesture={documentGesture}>
          <Animated.View style={[styles.documentViewport, documentTransformStyle]}>
            <Animated.FlatList
              ...
              // rendered window (initialNumToRender=1) unless this handler exists —
              // tapping a far page in the Pages sheet crashed the app without it.
              // Fall back to an estimated offset; the retry lands exactly once the
              // target cell has been measured.
              onScrollToIndexFailed={({ index, averageItemLength }) => {
                documentListRef.current?.scrollToOffset({
                  offset: index * (averageItemLength || 1),
                  animated: true,
                });
                setTimeout(() => {
                  documentListRef.current?.scrollToIndex({ index, animated: false, viewPosition: 0 });
                }, 250);
              }}
