...
const styles = StyleSheet.create({
  ...
  sectionBox: { marginBottom: 20, padding: 22, borderRadius: 22, borderWidth: 1 },
  header: { marginBottom: 0 },
  title: { fontSize: 26, fontWeight: '800', letterSpacing: -0.5 },
  subtitle: { fontSize: 12, marginTop: 6, fontWeight: '600' },
  quizCard: { borderRadius: 20, padding: 24, overflow: 'hidden' },
  ...
  subjectCard: { padding: 18, borderRadius: 18, marginBottom: 14, borderWidth: 1 },
