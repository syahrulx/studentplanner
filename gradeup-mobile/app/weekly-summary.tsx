...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '800', color: COLORS.navy, letterSpacing: -0.5 },
  card: { backgroundColor: COLORS.white, borderRadius: 24, padding: 26, marginBottom: 18, borderWidth: 1, borderColor: COLORS.border },
  cardLabel: { fontSize: 12, color: COLORS.gray, fontWeight: '800', marginBottom: 8, letterSpacing: 1 },
  cardValue: { fontSize: 32, fontWeight: '800', color: COLORS.navy, marginBottom: 4 },
