...
export default function StudyBuddyHub() {
  ...
  return (
    ...
    >
      <View style={styles.headerRow}>
        ...
        <Text style={[styles.title, { color: theme.text }]}>Study Buddy</Text>
      </View>

      <View style={[styles.infoCard, { backgroundColor: theme.primary + '14', borderColor: theme.primary + '30' }]}>
        <Text style={[styles.infoText, { color: theme.text }]}>
          Find peers who want to study the same subjects. Match with study buddies, schedule sessions, and stay accountable together.
        </Text>
      </View>
      ...
      <View style={[styles.placeholderCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
        ...
        <Text style={[styles.placeholderDesc, { color: theme.textSecondary }]}>
          Set your subjects and we’ll suggest study partners. You’ll be able to send requests and chat here.
        </Text>
      </View>
    </ScrollView>
  );
