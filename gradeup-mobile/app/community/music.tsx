  ...
  return (
    ...
    >
      <View style={styles.headerRow}>
        ...
        <Text style={[styles.title, { color: theme.text }]}>Music taste</Text>
      </View>

      <View style={[styles.infoCard, { backgroundColor: theme.primary + '14', borderColor: theme.primary + '30' }]}>
        <Text style={[styles.infoText, { color: theme.text }]}>
          Match with friends based on music taste. Share your favourite genres and artists to find like-minded peers.
        </Text>
      </View>
      ...
      <View style={[styles.placeholderCard, { backgroundColor: theme.card, borderColor: theme.border }]}>
        ...
        <Text style={[styles.placeholderDesc, { color: theme.textSecondary }]}>
          Add your music preferences and we’ll suggest friends with similar taste.
        </Text>
      </View>
    </ScrollView>
  );
