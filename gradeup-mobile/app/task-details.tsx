  ...
  return (
    <View style={[s.container, { backgroundColor: theme.background }]}>
      ...
      >
        ...
        <View style={s.infoGrid}>
          <View style={[s.infoCard, { backgroundColor: theme.card, borderColor: theme.cardBorder }]}>
            ...
            <View>
              ...
              <Text style={[s.infoValue, { color: task.needsDate ? theme.warning : theme.text }]}>
        ...
        {/* Source Section — Classroom vs AI-extracted message */}
        {task.id.startsWith('gc-') ? (
          <View style={s.sourceSection}>
            ...
            >
              ...
              {task.sourceMessage ? (
                <Text style={[s.sourceBody, { color: theme.text }]} numberOfLines={1}>
                  {task.sourceMessage}
                </Text>
              ) : null}
            </View>
