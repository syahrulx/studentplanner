...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', backgroundColor: 'rgba(248,250,252,0.8)', padding: 6, borderRadius: 22, borderWidth: 1, borderColor: COLORS.border, marginBottom: 28 },
  ...
  shareCard: { backgroundColor: '#eff6ff', borderRadius: 32, padding: 36, borderWidth: 1, borderColor: '#bfdbfe' },
  shareIcon: { width: 64, height: 64, backgroundColor: COLORS.white, borderRadius: 22, alignItems: 'center', justifyContent: 'center', marginBottom: 20 },
  shareTitle: { fontSize: 20, fontWeight: '800', color: COLORS.navy, marginBottom: 10, letterSpacing: -0.5 },
  ...
  textArea: { height: 200, backgroundColor: 'rgba(248,250,252,0.8)', borderWidth: 1, borderColor: COLORS.border, borderRadius: 28, padding: 24, fontSize: 14, marginBottom: 28, textAlignVertical: 'top' },
  ...
  uploadArea: { height: 200, borderWidth: 2, borderStyle: 'dashed', borderColor: COLORS.border, borderRadius: 32, backgroundColor: 'rgba(248,250,252,0.8)', alignItems: 'center', justifyContent: 'center', gap: 18 },
  uploadIcon: { width: 52, height: 52, backgroundColor: COLORS.white, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
