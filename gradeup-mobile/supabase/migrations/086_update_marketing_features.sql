...
INSERT INTO public.subscription_plan_features (tier, label, enabled, sort_order) VALUES
  ...
  ('plus', 'Premium App Themes & Widgets: Cat, Aurora, Spider, Mono visual styling', true, 2),
  ('plus', 'AI Subject Tutor ("Ask AI"): Reads all notes in a subject to answer homework questions', true, 3),
  ('plus', 'AI Tutor Active History: Keep 1 persistent active chat per subject', true, 4),
  ('plus', 'Bigger AI Flashcards: Generate up to 20 flashcards per deck in 1 tap', true, 5),
