-- =============================================================================
-- record_service_offer_use: block post author on “offer a service” listings
-- =============================================================================
-- Feedback (“It worked for me”) is for other students using someone’s open
-- listing — not for the person who posted the offer-type service.
...
BEGIN
  ...
  IF COALESCE(v_svc.service_kind, '') = 'offer' AND v_svc.author_id = v_uid THEN
    RAISE EXCEPTION 'Only students who use this listing can leave feedback';
  END IF;
