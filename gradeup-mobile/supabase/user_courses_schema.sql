-- ============================================================
-- USER COURSES / SUBJECTS – Run in Supabase SQL Editor
-- ============================================================
-- Each user has their own subjects. Used for tasks, study time,
-- notes, flashcards. Add subjects manually via the app.
-- ============================================================
